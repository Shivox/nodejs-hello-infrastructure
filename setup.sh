...
setup_dev_cluster() {
  ...
  minikube start -p=dev-cluster --driver=$minikube_vm_driver --disk-size='10000mb' --addons=ingress --dns-domain=ppro.dev --embed-certs=true
...
setup_prod_cluster() {
  ...
  minikube start -p=prod-cluster --driver=$minikube_vm_driver --disk-size='10000mb' --addons=ingress --dns-domain=ppro.prod --embed-certs=true
